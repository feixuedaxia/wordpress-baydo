...
if (!\function_exists('is_rml_folder')) {
    ...
    {
        return \is_int($obj) ? \is_rml_folder(\wp_rml_get_object_by_id($obj)) : $obj instanceof \MatthiasWeb\RealMediaLibrary\api\IFolder;
    }
}
...
if (!\function_exists('wp_rml_create')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\folder\CRUD::getInstance()->create($name, $parent, $type, $restrictions, $supress_validation, $return_existing_id);
    }
}
...
if (!\function_exists('wp_rml_update_count')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\attachment\CountCache::getInstance()->updateCountCache($folders, $attachments, $onlyReturn);
    }
}
if (!\function_exists('wp_rml_selector')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\attachment\Structure::getInstance()->getView()->selector($options);
    }
}
if (!\function_exists('wp_rml_dropdown')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\attachment\Structure::getInstance()->getView()->dropdown($selected, $disabled, $useAll);
    }
}
...
if (!\function_exists('wp_rml_create_all_parents_sql')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\Util::getInstance()->createSQLForAllParents($folder, $includeSelf, $until, $options);
    }
}
if (!\function_exists('wp_rml_all_children_sql_supported')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\Core::getInstance()->getActivator()->supportsChildQuery($force, $type);
    }
}
if (!\function_exists('wp_rml_create_all_children_sql')) {
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\Util::getInstance()->createSQLForAllChildren($folder, $includeSelf, $options);
    }
}
