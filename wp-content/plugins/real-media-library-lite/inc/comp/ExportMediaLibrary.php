...
class ExportMediaLibrary
{
    ...
    {
        register_rest_route(\MatthiasWeb\RealMediaLibrary\rest\Service::LEGACY_NAMESPACE, '/massedge/export', ['methods' => 'GET', 'callback' => [$this, 'export'], 'permission_callback' => [$this, 'permission_callback'], 'args' => ['type' => ['required' => \true, 'type' => 'string'], 'folder' => ['required' => \true, 'type' => 'integer']]]);
    }
    /**
