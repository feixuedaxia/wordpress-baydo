 ...
 */
abstract class Creatable extends \MatthiasWeb\RealMediaLibrary\folder\BaseFolder implements \MatthiasWeb\RealMediaLibrary\overrides\interfce\folder\IOverrideCreatable
{
    use FolderCreatable;
    ...
    public function insert($ids, $supress_validation = \false, $isShortcut = \false)
    {
        ...
        if (\is_array($ids)) {
            ...
            \MatthiasWeb\RealMediaLibrary\Util::getInstance()->doActionAnyParentHas($this, 'Folder/Insert', [$this->id, $ids, $this, $isShortcut, $sourceFolders]);
            return \true;
        } else {
    ...
    public function setParent($id, $ord = -1, $force = \false)
    {
        ...
        if ($this->id > -1) {
            ...
            \MatthiasWeb\RealMediaLibrary\Util::getInstance()->doActionAnyParentHas($this, 'Folder/RelocatedOrMoved', [$this, $id, $this->order, $force, $oldData]);
            $this->applySubfolderOrderBy();
        } else {
